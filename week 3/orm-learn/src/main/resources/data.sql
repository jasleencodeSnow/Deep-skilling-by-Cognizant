-- =========================================================================
-- Seed data for the orm-learn hands-on project (docs 1, 2 and 3)
-- Loaded automatically on startup (spring.sql.init.mode=always) after
-- Hibernate creates the schema from the @Entity classes (ddl-auto=create-drop).
-- =========================================================================

-- ---- Doc 1 - Hands on 1 / Doc 2 - Hands on 1: country reference data ------
...
-- ---- Doc 2 - Hands on 2: stock reference data ------------------------------
INSERT INTO stock (st_code, st_date, st_open, st_close, st_volume) VALUES ('FB', '2019-09-03', 184.0, 182.39, 9779400);
...
INSERT INTO stock (st_code, st_date, st_open, st_close, st_volume) VALUES ('FB', '2019-09-25', 181.45, 182.8, 18068300);
...
INSERT INTO stock (st_code, st_date, st_open, st_close, st_volume) VALUES ('GOOGL', '2019-04-25', 1270.3, 1267.34, 1567200);
INSERT INTO stock (st_code, st_date, st_open, st_close, st_volume) VALUES ('GOOGL', '2019-04-26', 1273.38, 1277.42, 1361400);
INSERT INTO stock (st_code, st_date, st_open, st_close, st_volume) VALUES ('GOOGL', '2019-04-29', 1280.51, 1296.2, 3618400);
...
-- ---- Doc 2 - Hands on 3: payroll schema (department / employee / skill) --
...
INSERT INTO employee (em_id, em_name, em_salary, em_permanent, em_date_of_birth, em_dp_id) VALUES (1, 'Arjun Rao', 72000, true, '1990-01-15', 1);
INSERT INTO employee (em_id, em_name, em_salary, em_permanent, em_date_of_birth, em_dp_id) VALUES (2, 'Meera Iyer', 68000, true, '1988-03-22', 1);
INSERT INTO employee (em_id, em_name, em_salary, em_permanent, em_date_of_birth, em_dp_id) VALUES (3, 'Kiran Shah', 55000, false, '1995-07-09', 2);
INSERT INTO employee (em_id, em_name, em_salary, em_permanent, em_date_of_birth, em_dp_id) VALUES (4, 'Priya Nair', 61000, true, '1992-11-30', 2);
INSERT INTO employee (em_id, em_name, em_salary, em_permanent, em_date_of_birth, em_dp_id) VALUES (5, 'Vivek Kumar', 80000, true, '1985-05-18', 3);
INSERT INTO employee (em_id, em_name, em_salary, em_permanent, em_date_of_birth, em_dp_id) VALUES (6, 'Sita Reddy', 47000, false, '1998-09-02', 3);
...
INSERT INTO skill (sk_id, sk_name) VALUES (4, 'React');
INSERT INTO skill (sk_id, sk_name) VALUES (5, 'Communication');

-- Doc 2 - Hands on 6: existing employee_skill relationships.
-- Employee 2 + Skill 3 is deliberately NOT linked yet - Hands on 6's
-- testAddSkillToEmployee() adds this relationship at runtime.
...
INSERT INTO quiz_user (us_id, us_name) VALUES (1, 'john.doe');
...
INSERT INTO question (qu_id, qu_text) VALUES (3, 'The HTML document itself begins with <html> and ends </html>. State True or False');
INSERT INTO question (qu_id, qu_text) VALUES (4, 'Choose the right option to store text value in a variable');

INSERT INTO quiz_option (op_id, op_qu_id, op_text, op_score) VALUES (1, 1, '.xhtm', 0.0);
INSERT INTO quiz_option (op_id, op_qu_id, op_text, op_score) VALUES (2, 1, '.ht', 0.0);
INSERT INTO quiz_option (op_id, op_qu_id, op_text, op_score) VALUES (3, 1, '.html', 1.0);
INSERT INTO quiz_option (op_id, op_qu_id, op_text, op_score) VALUES (4, 1, '.htmx', 0.0);

INSERT INTO quiz_option (op_id, op_qu_id, op_text, op_score) VALUES (5, 2, '5', 0.0);
INSERT INTO quiz_option (op_id, op_qu_id, op_text, op_score) VALUES (6, 2, '3', 0.0);
INSERT INTO quiz_option (op_id, op_qu_id, op_text, op_score) VALUES (7, 2, '4', 0.0);
INSERT INTO quiz_option (op_id, op_qu_id, op_text, op_score) VALUES (8, 2, '6', 1.0);

INSERT INTO quiz_option (op_id, op_qu_id, op_text, op_score) VALUES (9, 3, 'false', 0.0);
INSERT INTO quiz_option (op_id, op_qu_id, op_text, op_score) VALUES (10, 3, 'true', 1.0);

INSERT INTO quiz_option (op_id, op_qu_id, op_text, op_score) VALUES (11, 4, '''John''', 0.5);
INSERT INTO quiz_option (op_id, op_qu_id, op_text, op_score) VALUES (12, 4, 'John', 0.0);
INSERT INTO quiz_option (op_id, op_qu_id, op_text, op_score) VALUES (13, 4, '"John"', 0.5);
INSERT INTO quiz_option (op_id, op_qu_id, op_text, op_score) VALUES (14, 4, '/John/', 0.0);

INSERT INTO attempt (at_id, at_us_id, at_date) VALUES (1, 1, '2024-01-10');
...
-- The options the user actually selected for each question in the attempt
